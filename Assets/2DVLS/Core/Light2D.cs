            ...
            for (int i = 0; i < rays; i++)
            {
                ...
                if (flagObjsInRange && (hit2d || hit3d))
                {
                    ...
                    if (hit2d)
                    {
                        ...
                        verts.Add(transform.InverseTransformPoint(new Vector3(rhit2D.point.x, rhit2D.point.y - 1, transform.position.z)));//new Vector3(rhit2D.point.x, rhit2D.point.y, transform.position.z));//transform.InverseTransformPoint(new Vector3(rhit2D.point.x, rhit2D.point.y, transform.position.z)));
                    }
                    #endif
